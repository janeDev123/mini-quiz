    <x-layouts.admin>
            ...
            <form method="POST" action="{{ route('admin.questions.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="body" rows="3"
                            ...
                            placeholder="Enter your question here...">{{ old('body') }}</textarea>
                    @error('body')
                ...
                <div class="mb-2">
                    ...
                    <div id="choices-container" class="space-y-3">
                        @php $oldChoices = old('choices', [['body'=>''],['body'=>'']]); @endphp
                        @foreach ($oldChoices as $i => $choice)
        ...
        <script>
            let choiceIndex = {{ count(old('choices', [[], []])) }};
